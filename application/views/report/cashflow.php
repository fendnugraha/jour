<?php
$cfpercent = round(($this->finance_model->cashflowCount('0000-00-00', $endDate) - $this->finance_model->cashflowCount('0000-00-00', $startDate)) / $this->finance_model->cashflowCount('0000-00-00', $startDate) * 100, 2);
    ...
    <div class="col-sm">
        <div class="card bg-primary text-bg-dark">
            <div class="card-body">
                ...
                <h2 class="d-flex justify-content-between"><i class="fa-solid fa-briefcase"></i> <b><?= $updown . " " . number_format($this->finance_model->cashflowCount('0000-00-00', $endDate) - $this->finance_model->cashflowCount('0000-00-00', $startDate)); ?> ,-</b></h2>
            </div>
        </div>
    </div>
    <div class="col-sm">
    ...
    <div class="card-body">
        <table class="table">
            ...
            <tr>
                <td>Hutang</td>
                <td><i class="fa-solid fa-rupiah-sign"></i></td>
                <td><?= number_format($this->finance_model->totalDebetCreditCashflowCount('20100%', $startDate, $endDate)); ?></td>
            </tr>
            <tr>
