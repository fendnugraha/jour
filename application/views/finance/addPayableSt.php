    ...
    <div class="card-body">
        <div class="row">
            <div class="form-addproduct col-sm">
                <form action="<?= base_url('finance/addPayableSt'); ?>" method="post">
                    <div class="mb-2 row">
                    ...
                    <div class="mb-2 row">
                        <label for="acc_credit" class="col-sm col-form-label">Akun Hutang</label>
                        <div class="col-sm-8">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?= base_url('finance/Payable'); ?>">Kembali</a>
                    </div>
                </form>
            </div>
