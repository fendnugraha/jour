    ...
    <div class="card-body">
        <div class="row">
            <div class="form-addproduct col-sm">
                <form action="<?= base_url('finance/addReceivableSales'); ?>" method="post">
                    <div class="mb-2 row">
                    ...
                    <div class="mb-2 row">
                        <label for="HPP" class="col-sm col-form-label">HPP (Rp)</label>
                        <div class="col-sm-8">
                            <input type="number" class="form-control" name="HPP" id="HPP" value="<?= set_value('HPP'); ?>" placeholder="HPP">
                        </div>
                    </div>
